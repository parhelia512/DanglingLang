...
{
  // Verbatim content from D:\Dropbox\Progetti\C#\DanglingLang\DanglingLang\Tokenizer/DanglingLang.y - 03/07/2013 10.31.30
#line 41 "D:\Dropbox\Progetti\C#\DanglingLang\DanglingLang\Tokenizer/DanglingLang.y"
	internal FunctionDecl Prog;
  // End verbatim content from D:\Dropbox\Progetti\C#\DanglingLang\DanglingLang\Tokenizer/DanglingLang.y - 03/07/2013 10.31.30
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[3] = new State(new int[]{133,6,130,7,129,36,138,37,139,38,136,75,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106,146,83,147,84,148,121,128,-2},new int[]{-7,4,-6,5,-1,74,-11,108});
    states[4] = new State(-4);
    states[5] = new State(-5);
    states[6] = new State(-11);
    states[7] = new State(new int[]{61,8,40,66,43,-36,45,-36,42,-36,47,-36,37,-36,33,-36,94,-36,140,-36,141,-36,142,-36,144,-36,143,-36,145,-36,133,-36,130,-36,129,-36,138,-36,139,-36,136,-36,131,-36,132,-36,126,-36,123,-36,134,-36,135,-36,137,-36,149,-36,146,-36,147,-36,148,-36,128,-36,125,-36});
    ...
    states[12] = new State(new int[]{43,-24,45,-24,42,15,47,17,37,19,33,21,94,22,140,-24,141,-24,142,-24,144,-24,143,-24,145,34,133,-24,130,-24,129,-24,138,-24,139,-24,136,-24,131,-24,132,-24,40,-24,126,-24,123,-24,134,-24,135,-24,137,-24,149,-24,146,-24,147,-24,148,-24,128,-24,125,-24,44,-24,41,-24});
    states[13] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1,14});
    states[14] = new State(new int[]{43,-25,45,-25,42,15,47,17,37,19,33,21,94,22,140,-25,141,-25,142,-25,144,-25,143,-25,145,34,133,-25,130,-25,129,-25,138,-25,139,-25,136,-25,131,-25,132,-25,40,-25,126,-25,123,-25,134,-25,135,-25,137,-25,149,-25,146,-25,147,-25,148,-25,128,-25,125,-25,44,-25,41,-25});
    states[15] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1,16});
    states[16] = new State(new int[]{43,-26,45,-26,42,-26,47,-26,37,-26,33,21,94,22,140,-26,141,-26,142,-26,144,-26,143,-26,145,34,133,-26,130,-26,129,-26,138,-26,139,-26,136,-26,131,-26,132,-26,40,-26,126,-26,123,-26,134,-26,135,-26,137,-26,149,-26,146,-26,147,-26,148,-26,128,-26,125,-26,44,-26,41,-26});
    states[17] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1,18});
    states[18] = new State(new int[]{43,-27,45,-27,42,-27,47,-27,37,-27,33,21,94,22,140,-27,141,-27,142,-27,144,-27,143,-27,145,34,133,-27,130,-27,129,-27,138,-27,139,-27,136,-27,131,-27,132,-27,40,-27,126,-27,123,-27,134,-27,135,-27,137,-27,149,-27,146,-27,147,-27,148,-27,128,-27,125,-27,44,-27,41,-27});
    states[19] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1,20});
    states[20] = new State(new int[]{43,-28,45,-28,42,-28,47,-28,37,-28,33,21,94,22,140,-28,141,-28,142,-28,144,-28,143,-28,145,34,133,-28,130,-28,129,-28,138,-28,139,-28,136,-28,131,-28,132,-28,40,-28,126,-28,123,-28,134,-28,135,-28,137,-28,149,-28,146,-28,147,-28,148,-28,128,-28,125,-28,44,-28,41,-28});
    ...
    states[23] = new State(new int[]{43,-32,45,-32,42,-32,47,-32,37,-32,33,-32,94,22,140,-32,141,-32,142,-32,144,-32,143,-32,145,34,133,-32,130,-32,129,-32,138,-32,139,-32,136,-32,131,-32,132,-32,40,-32,126,-32,123,-32,134,-32,135,-32,137,-32,149,-32,146,-32,147,-32,148,-32,128,-32,125,-32,44,-32,41,-32});
    states[24] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1
= new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71},new int[]{-1,72});
    states[72] = new State(new int[]{43,-37,45,-37,42,-37,47,-37,37,-37,33,-37,94,-37,140,-37,141,-37,142,-37,144,-37,143,-37,145,34,133,-37,130,-37,129,-37,138,-37,139,-37,136,-37,131,-37,132,-37,40,-37,126,-37,123,-37,134,-37,135,-37,137,-37,149,-37,146,-37,147,-37,148,-37,128,-37,125,-37,44,-37,41,-37});
    states[73] = new State(new int[]{43,11,45,13,42,15,47,17,37,19,33,21,94,22,140,24,141,26,142,28,144,30,143,32,145,34,41,-53,44,-53});
    states[74] = new State(new int[]{43,11,45,13,42,15,47,17,37,19,33,21,94,22,140,24,141,26,142,28,144,30,143,32,145,34,133,-13,130,-13,129,-13,138,-13,139,-13,136,-13,131,-13,132,-13,40,-13,126,-13,123,-13,134,-13,135,-13,137,-13,149,-13,146,-13,147,-13,148,-13,128,-13,125,-13});
    states[75] = new State(new int[]{130,76});
    states[76] = new State(new int[]{123,77,130,-57});
    states[77] = new State(new int[]{129,-47,138,-47,139,-47,136,-45,43,-47,45,-47,131,-47,132,-47,40,-47,130,-47,126,-47,125,-45,146,-45,147,-45},new int[]{-2,42,-3,78});
    ...
    states[87] = new State(-9,new int[]{-8,88});
    states[88] = new State(new int[]{125,89,133,6,130,7,129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106},new int[]{-6,90,-1,74});
    ...
    states[94] = new State(new int[]{133,6,130,7,129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106},new int[]{-6,95,-1,74});
    ...
    states[99] = new State(new int[]{133,6,130,7,129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106},new int[]{-6,100,-1,74});
    ...
    states[106] = new State(new int[]{129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,130,65,126,71,133,-18,123,-18,134,-18,135,-18,137,-18,149,-18,146,-18,147,-18,148,-18,128,-18,125,-18},new int[]{-1,107});
    states[107] = new State(new int[]{43,11,45,13,42,15,47,17,37,19,33,21,94,22,140,24,141,26,142,28,144,30,143,32,145,34,133,-19,130,-19,129,-19,138,-19,139,-19,136,-19,131,-19,132,-19,40,-19,126,-19,123,-19,134,-19,135,-19,137,-19,149,-19,146,-19,147,-19,148,-19,128,-19,125,-19});
    states[108] = new State(new int[]{130,109});
    states[109] = new State(new int[]{40,110});
    states[110] = new State(new int[]{146,83,147,84,136,85,41,-49,44,-49},new int[]{-4,111,-11,119});
    states[111] = new State(new int[]{41,112,44,116});
    states[112] = new State(new int[]{123,113});
    states[113] = new State(-9,new int[]{-8,114});
    states[114] = new State(new int[]{125,115,133,6,130,7,129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106},new int[]{-6,90,-1,74});
    ...
    states[123] = new State(new int[]{146,83,147,84,136,85,41,-49,44,-49},new int[]{-4,124,-11,119});
    states[124] = new State(new int[]{41,125,44,116});
    states[125] = new State(new int[]{123,126});
    states[126] = new State(-9,new int[]{-8,127});
    states[127] = new State(new int[]{125,128,133,6,130,7,129,36,138,37,139,38,136,39,43,46,45,48,131,50,132,56,40,62,126,71,123,87,134,91,135,96,137,101,149,106},new int[]{-6,90,-1,74});
    ...
    rules[11] = new Rule(-6, new int[]{133});
    rules[12] = new Rule(-6, new int[]{130,61,-1,133});
    rules[13] = new Rule(-6, new int[]{-1});
    rules[14] = new Rule(-6, new int[]{123,-8,125});
    rules[15] = new Rule(-6, new int[]{134,40,-1,41,-6});
    rules[16] = new Rule(-6, new int[]{135,40,-1,41,-6});
    rules[17] = new Rule(-6, new int[]{137,40,-1,41,133});
    rules[18] = new Rule(-6, new int[]{149});
    rules[19] = new Rule(-6, new int[]{149,-1});
    rules[20] = new Rule(-1, new int[]{129});
    rules[21] = new Rule(-1, new int[]{138});
    rules[22] = new Rule(-1, new int[]{139});
    rules[23] = new Rule(-1, new int[]{136,130,123,-2,-1,125});
    rules[24] = new Rule(-1, new int[]{-1,43,-1});
    rules[25] = new Rule(-1, new int[]{-1,45,-1});
    rules[26] = new Rule(-1, new int[]{-1,42,-1});
    rules[27] = new Rule(-1, new int[]{-1,47,-1});
    rules[28] = new Rule(-1, new int[]{-1,37,-1});
    rules[29] = new Rule(-1, new int[]{43,-1});
    rules[30] = new Rule(-1, new int[]{45,-1});
    rules[31] = new Rule(-1, new int[]{-1,33});
    rules[32] = new Rule(-1, new int[]{-1,94,-1});
    rules[33] = new Rule(-1, new int[]{131,40,-1,44,-1,41});
    rules[34] = new Rule(-1, new int[]{132,40,-1,44,-1,41});
    rules[35] = new Rule(-1, new int[]{40,-1,41});
    rules[36] = new Rule(-1, new int[]{130});
    rules[37] = new Rule(-1, new int[]{126,-1});
    rules[38] = new Rule(-1, new int[]{-1,140,-1});
    rules[39] = new Rule(-1, new int[]{-1,141,-1});
    rules[40] = new Rule(-1, new int[]{-1,142,-1});
    rules[41] = new Rule(-1, new int[]{-1,144,-1});
    rules[42] = new Rule(-1, new int[]{-1,143,-1});
    rules[43] = new Rule(-1, new int[]{-1,145,130});
    rules[44] = new Rule(-1, new int[]{130,40,-5,41});
    rules[45] = new Rule(-3, new int[]{});
    rules[46] = new Rule(-3, new int[]{-3,-11,130,59});
    rules[47] = new Rule(-2, new int[]{});
    rules[48] = new Rule(-2, new int[]{-2,-1,44});
    rules[49] = new Rule(-4, new int[]{});
    rules[50] = new Rule(-4, new int[]{-11,130});
    rules[51] = new Rule(-4, new int[]{-4,44,-11,130});
    rules[52] = new Rule(-5, new int[]{});
    rules[53] = new Rule(-5, new int[]{-1});
    rules[54] = new Rule(-5, new int[]{-5,44,-1});
    rules[55] = new Rule(-11, new int[]{146});
    rules[56] = new Rule(-11, new int[]{147});
    rules[57] = new Rule(-11, new int[]{136,130});
  }
...
{CurrentSemanticValue.stmt = new While(ValueStack[ValueStack.Depth-3].exp, ValueStack[ValueStack.Depth-1].stmt ?? new Block(new List<Stmt>()));}
        break;
      case 17: // stmt -> PRINT, '(', exp, ')', NEWLINE
...
{ CurrentSemanticValue.exp = new BoolLiteral(false); }
        break;
      case 23: // exp -> STRUCT, ID, '{', structFieldValues, exp, '}'
...
{CurrentSemanticValue.structDecl = new StructDecl();}
        break;
      case 46: // structFieldDecl -> structFieldDecl, type, ID, ';'
...
{ValueStack[ValueStack.Depth-4].structDecl.AddField(ValueStack[ValueStack.Depth-2].identifier, ValueStack[ValueStack.Depth-3].identifier); CurrentSemanticValue.structDecl = ValueStack[ValueStack.Depth-4].structDecl;}
        break;
      case 47: // structFieldValues -> /* empty */
...
{CurrentSemanticValue.structValue = new StructValue();}
        break;
      case 48: // structFieldValues -> structFieldValues, exp, ','
...
{CurrentSemanticValue.functionDecl = new FunctionDecl(); CurrentSemanticValue.functionDecl.AddParam(ValueStack[ValueStack.Depth-1].identifier, ValueStack[ValueStack.Depth-2].identifier);}
        break;
      case 51: // funcParams -> funcParams, ',', type, ID
